...
func (player *Player) sendCurrencyMapInfo() {
	data, err := proto.Marshal(&pb.CurrencyMap{
		Data: data.DefaultManager().GetCurrencyMap(),
	})
	...
	player.sendRequest(pb.RequestCommand_RC_CURRENCY_MAP, data)
}
