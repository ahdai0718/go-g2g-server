...
var (
	defaultPlayerManager = &PlayerManager{
		playerMapByID:       make(map[string]player.Player, maxPlayer),
		playerMapByWC:       make(map[*network.WebsocketConnection]player.Player, maxPlayer),
...
type PlayerManager struct {
	playerMapByID       map[string]player.Player
	playerMapByWC       map[*network.WebsocketConnection]player.Player
